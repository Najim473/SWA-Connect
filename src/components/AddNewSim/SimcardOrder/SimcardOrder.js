...
<div style={{padding:'0px 50px'}} class="mb-3">
 <label for="exampleFormControlInput1" class="form-label">SIM Order Number</label>
 <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="SIM Order Number"/>
</div> 
<div style={{padding:'0px 50px'}} class="mb-3">
...
<div style={{padding:'0px 50px'}} class="mb-3">
 ...
 <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="Batch Number"/>
</div> 
<div style={{padding:'0px 50px'}} class="mb-3">
 <label for="exampleFormControlInput1" class="form-label">Tracking Number</label>
 <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="Tracking Number"/>
</div> 
<div style={{padding:'0px 50px'}} class="mb-3">
