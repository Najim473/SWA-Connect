...
const empList = [
  { name: "Neeraj", email: 'neeraj@gmail.com', phone: 9876543210, city: "Bangalore" }
//   ,
...
/>
      ...
      <div style={{boxShadow:'none',border:'none',margin:'20px',border:'1px solid #000',marginBottom:'20px',display:'flex',alignItems:'center'}}>
      <Typography component="div">
      <Box sx={{fontWeight:'bold', width:'30px'}} fontWeight="fontWeightLight" m={1}>
        Note 
      </Box>       
    </Typography>
    <Input style={{marginLeft:'50px',minWidth:'60%'}} placeholder="Write Here" inputProps={{ 'aria-label': 'description' }} disableUnderline={true} />
      </div>
    </div>
  );
}
